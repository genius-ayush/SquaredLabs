...
function Hero() {
  ...
  return (
    <div className="h-screen md:mt-20" data-aos="fade-right">
      ...
      <div className="flex justify-center justify-items-center items-center content-center">
      <button onClick={() => window.open("https://potentia.squaredlabs.io/", '_blank', 'noopener,noreferrer')} type="button" className= "flex text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-[100px] py-4 text-center me-2 mb-2 ">Start Trading</button>
      </div>

      <div className="flex justify-center justify-items-center items-center content-center mt-3 lg:mt-0 ">
      <button onClick={() => window.open("https://squaredlabs-io.gitbook.io/squaredlabs.io", '_blank', 'noopener,noreferrer')} type="button" class="text-gray-900 hover:text-black border border-gray-800 hover:bg-white focus:ring-4 focus:outline-none focus:ring-gray-500 font-medium rounded-lg text-sm px-[110px] py-4 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-black dark:hover:black dark:focus:ring-gray-800">Read Docs</button>
      </div>
